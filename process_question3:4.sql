...
SELECT	
	*,
	AVG(year_2006 + next_year_2007 + next_year_2008 + next_year_2009 + next_year_2010 + next_year_2011 + next_year_2012 + next_year_2013 + next_year_2014 + next_year_2015 + next_year_2016) AS avg_value,
	AVG(percentual_growth1 + percentual_growth2 + percentual_growth3 + percentual_growth4 + percentual_growth5 + percentual_growth6 + percentual_growth7 + percentual_growth8 + percentual_growth9 + percentual_growth10) AS avg_percentual_growth
