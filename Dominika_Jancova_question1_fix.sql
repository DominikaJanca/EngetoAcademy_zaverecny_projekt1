...
CREATE OR REPLACE VIEW v_Dominika_Jancova_project_SQL_primary_final_question_1 AS
	...
	FROM t_Dominika_Jancova_project_SQL_primary_final AS payroll_1
	JOIN t_Dominika_Jancova_project_SQL_primary_final AS payroll_2
		ON payroll_2.payroll_year = payroll_1.payroll_year + 1
	WHERE 
		payroll_1.payroll_quarter = payroll_2.payroll_quarter AND
		payroll_1.industry_branch_code = payroll_2.industry_branch_code;
...
CREATE OR REPLACE VIEW v_Dominika_Jancova_project_SQL_primary_final_question_1 AS
	SELECT
		...
		CASE 
			...
			ELSE 0
		END AS 'decrease_of_payroll'
	FROM t_Dominika_Jancova_project_SQL_primary_final AS t_payroll_1
	JOIN t_Dominika_Jancova_project_SQL_primary_final AS t_payroll_2
		ON t_payroll_2.payroll_year = t_payroll_1.payroll_year + 1
	WHERE 
		t_payroll_1.payroll_quarter = t_payroll_2.payroll_quarter AND
		t_payroll_1.industry_branch_code = t_payroll_2.industry_branch_code;
...
FROM v_Dominika_Jancova_project_SQL_primary_final_question_1 AS v_payroll_1
JOIN v_Dominika_Jancova_project_SQL_primary_final_question_1 AS v_payroll_2
	ON vDJ2.payroll_next_year = vDJ1.payroll_next_year + 1
JOIN v_Dominika_Jancova_project_SQL_primary_final_question_1 AS v_payroll_3
	ON vDJ3.payroll_next_year = vDJ1.payroll_next_year + 2
JOIN v_Dominika_Jancova_project_SQL_primary_final_question_1 AS v_payroll_4
	ON vDJ4.payroll_next_year = vDJ1.payroll_next_year + 3
WHERE 
	v_payroll_1.payroll_quarter = v_payroll_2.payroll_quarter AND
	v_payroll_1.industry_branch_code = v_payroll_2.industry_branch_code AND
	v_payroll_1.industry_branch_code = v_payroll_3.industry_branch_code AND
	v_payroll_1.payroll_quarter = v_payroll_3.payroll_quarter AND
	v_payroll_1.payroll_quarter = v_payroll_4.payroll_quarter AND
	v_payroll_1.industry_branch_code = v_payroll_4.industry_branch_code;
